...
<body>
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#">Tạo tài khoản</a>
                    </li>
                    <?php
                        if(isset($_SESSION['username'])){
    ...
    <!-- Register Form {fixed}  -->
    <div id="registerForm" class="small p-3">
        <form action="../ClientController/register.php" method="post">
            <p>Tạo tài khoản mới. <a href="./login.php">Đã có tài khoản?</a></p>
            <div class="form-group">
                <span class="text-danger" id="wrong-un">*Username field chưa hợp lệ</span>
                <label for="username">Username:</label>
                <input type="text" name="username" id="username" placeholder="Nhập vào tên đăng nhập">
            </div>
            <div class="form-group mt-1 mb-1">
            <span class="text-danger" id="wrong-pw">*Password field chưa hợp lệ</span>
                <label for="password">Password:</label>
                <input type="text" name="password" id="password" placeholder="Nhập vào mật khẩu">
            </div>
            <input type="hidden" name="register">
        </form>
            <button class="p-1 rounded" id="btn-register">Đăng ký</button>
    </div>
    <!-- Announcer -->
    <div id="announcer">
        <?php

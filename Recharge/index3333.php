<!DOCTYPE html>
  ...
  <body>
      <script type="text/javascript"> new WOW().init(); </script>
        <div class="container">
	       <a href="https://thesieutoc.net" target="_blank"><img src="https://thesieutoc.net/assets/images/ok.png" width="40%" align="center" alt="" /></a></br>
		   <span class="badge badge-danger" style="margin-left:3%;">Nạp thẻ Thesieutoc API với khả năng bảo mật cực cao . Phiên bản Final-version !</span>
		   <div id="status"></div>
			...
			<div class="col-md-5">
				<form method="POST" action="#" id="myform">
				   <table class="table table-condensed table-bordered">
				     <tbody>
					 <tr bgcolor="4682B4">
					     <td colspan="2" align="center"><h3 style="color:white;">« Nạp Thẻ »</h3> </td>
					 </tr>
					 <tr>
		...
		<div class="col-md-7">
		     <h4 class="text-center"> « Tiện Ích Nạp Thẻ »</h4>
			    <div class="panel-body">
                        <marquee><p><span style="color: #ff6600;"><strong>Bạn Cảm Thấy Phiên Bản Mới Như Thế Nào Nè >< </strong></span></p></marquee>
    ...
    <div id="collapsep" class="collapse" aria-labelledby="headingp" data-parent="#accordion">
      <div class="card-body table-responsive">
        <ul>
		  ...
		  <li>Để lập lệnh rút tiền chủ tài khoản cần thiết lập tài khoản ngân hàng trong hồ sơ tài khoản của mình. Các thiết lập bao gồm: Tên ngân hàng, Chi nhánh, Chủ tài khoản, Số tài khoản.</li> <li>Chủ tài khoản chịu trách nhiệm sử dụng tài khoản theo đúng quy định của TheSieuToc.</li></ul>
	  </div>
    </div>
  </div>
